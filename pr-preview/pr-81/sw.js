...
const BUILD = "1a174519";
const CACHE = `grocery-run-${BUILD}`;
const PRECACHE = ["./","./catalog.json","./manifest.webmanifest","./icon.svg","./apple-touch-icon.png","./assets/index-CM4t1hfz.js","./assets/index.esm-BZ89jI29.js","./assets/index.esm-BnvqDY3i.js","./assets/index.esm-CVyPRkR0.js","./assets/index.esm2017-DM5qQddP.js"];
