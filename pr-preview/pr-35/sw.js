...
const BUILD = "0722edd3";
const CACHE = `grocery-run-${BUILD}`;
const PRECACHE = ["./","./catalog.json","./manifest.webmanifest","./icon.svg","./apple-touch-icon.png","./assets/index-vNWbxxl0.js","./assets/index.esm-CGUBBTKv.js","./assets/index.esm-4Qk6yQPZ.js","./assets/index.esm2017-De2M7SNX.js"];
