...
const BUILD = "6a6f85dd";
const CACHE = `grocery-run-${BUILD}`;
const PRECACHE = ["./","./catalog.json","./manifest.webmanifest","./icon.svg","./apple-touch-icon.png","./assets/index-CECl6PBm.js","./assets/index.esm-wz6UBbSw.js","./assets/index.esm-DDW_SUeq.js","./assets/index.esm2017-bddn-IBG.js"];
