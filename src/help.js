...
/*  What the app is, and the questions it actually raises.
    ...
    as the tab bar spells it — see parseHelpMarkup in lib.js, and the test
...
export const FAQS = [
  ...
  },
  {
    ...
    a: "Yes. In {Recipes}, press [[Add a meal]], then open [[Start from a recipe or link]], and paste the whole page. It fills in the name, servings, ingredients and the steps. Check it before saving — a paste is a starting point, not the final word. If it invents a name you already have, it offers the existing ingredient under the row; take the offer.",
