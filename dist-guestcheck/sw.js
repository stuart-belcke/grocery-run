...
const BUILD = "a1953203";
const CACHE = `grocery-run-${BUILD}`;
const PRECACHE = ["./","./catalog.json","./manifest.webmanifest","./icon.svg","./apple-touch-icon.png","./assets/index-DbONsNk6.js","./assets/index.esm-C54IB2gS.js","./assets/index.esm-CQJTKRfk.js","./assets/index.esm2017-DKgin3cm.js"];
